...
<body>
    <main>
         <section class="w-100 h-100 mt-5">
                ...
                <article class="col-md-6 tekst justify-content-center">
                <h1 style="font-size: 3rem;">Over ons</h1>
                    <p class="mt-5" style="font-size: 1.2rem;">Hobo is de perfecte streaming website die je maar kan gebruiken.
