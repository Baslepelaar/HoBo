            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input class="text-center mb-1" type="password" name="password" style="height: 5vh; border-radius: 1vh; border: 2px solid grey;" placeholder="Wachtwoord" required>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input class="text-center mb-1" type="password" name="password-conf" class="text-center" style="height: 5vh; border-radius: 1vh; border: 2px solid grey;" placeholder="Wachtwoord bevestigen">
                    </div>
                  </div>
                </div>
